                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        <div className="space-y-1">
                          <Label htmlFor="fullName-mobile" className="text-xs">{t('checkoutForm.fullName')}</Label>
                          <Input id="fullName-mobile" name="fullName" value={formData.fullName} onChange={handleInputChange} placeholder={t('checkoutForm.namePlaceholder')} className={`${isRTL ? "text-right" : "text-left"} h-9 text-sm`} maxLength={100} />
                        </div>
                        <div className="space-y-1">
                          <Label htmlFor="email-mobile" className="text-xs">{t('checkoutForm.email')}</Label>
                          <Input id="email-mobile" name="email" type="email" value={formData.email} onChange={handleInputChange} placeholder="example@email.com" className="text-left h-9 text-sm" dir="ltr" maxLength={255} />
                        </div>
                        <div className="space-y-1">
                          <Label htmlFor="phone-mobile" className="text-xs">{t('checkoutForm.phone')}</Label>
                          <Input id="phone-mobile" name="phone" type="tel" value={formData.phone} onChange={handleInputChange} placeholder="0501234567" className="text-left h-9 text-sm" dir="ltr" maxLength={10} />
                        </div>
                        <div className="grid grid-cols-2 gap-2">
                          <div className="space-y-1">
                            <Label htmlFor="city-mobile" className="text-xs">{t('checkoutForm.city')}</Label>
                            <Input id="city-mobile" name="city" value={formData.city} onChange={handleInputChange} placeholder={t('checkoutForm.cityPlaceholder')} className={`${isRTL ? "text-right" : "text-left"} h-9 text-sm`} maxLength={50} />
                          </div>
                          <div className="space-y-1">
                            <Label htmlFor="address-mobile" className="text-xs">{t('checkoutForm.address')}</Label>
                            <Input id="address-mobile" name="address" value={formData.address} onChange={handleInputChange} placeholder={t('checkoutForm.addressPlaceholder')} className={`${isRTL ? "text-right" : "text-left"} h-9 text-sm`} maxLength={200} />
                          </div>
                        </div>
                        <div className="space-y-1">
                          <Label htmlFor="notes-mobile" className="text-xs">{t('checkoutForm.notes')}</Label>
                          <Textarea id="notes-mobile" name="notes" value={formData.notes} onChange={handleInputChange} placeholder={t('checkoutForm.notesPlaceholder')} className={`${isRTL ? "text-right" : "text-left"} resize-none text-sm`} rows={2} maxLength={500} />
                        </div>
                      </div>
