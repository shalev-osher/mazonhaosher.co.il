...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-6 relative overflow-hidden">
      {/* Decorative gradient background - Blue theme (no cyan/green tones) */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-indigo-600 to-blue-900" />
      <div className="absolute inset-0 opacity-30" style={{ backgroundImage: 'radial-gradient(circle at 0% 0%, hsl(220 90% 55%) 0%, transparent 40%), radial-gradient(circle at 100% 100%, hsl(235 90% 50% / 0.5) 0%, transparent 50%)' }} />
