...
const Footer = () => {
  ...
  return <>
      ...
      <div className="fixed bottom-[3.25rem] md:bottom-[3.75rem] left-0 right-0 z-40 bg-amber-100 dark:bg-amber-900 border-t border-amber-500/20 shadow-sm h-7 md:h-8 grid place-items-center">
