      ...
      <footer className="fixed bottom-0 left-0 right-0 z-40 py-0.5 md:py-1 bg-background border-t border-amber-500/30">
        <div className="w-full px-2 md:px-4">
          <div className="flex items-center justify-center gap-0">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/972546791198" target="_blank" rel="noopener noreferrer" className="w-14 md:w-16 flex flex-col items-center gap-0 py-0.5 md:py-1 transition-all duration-300 rounded-lg group hover:bg-muted">
            ...
            <span className="text-[8px] md:text-[10px] font-medium text-muted-foreground group-hover:text-foreground truncate">
              WhatsApp
            </span>
            </a>
            
            {/* Facebook */}
            <a href="https://www.facebook.com/p/%D7%9E%D7%96%D7%95%D7%9F-%D7%94%D7%90%D7%95%D7%A9%D7%A8-61565573526817/" target="_blank" rel="noopener noreferrer" className="w-14 md:w-16 flex flex-col items-center gap-0 py-0.5 md:py-1 transition-all duration-300 rounded-lg group hover:bg-muted">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/mazonaosher/" target="_blank" rel="noopener noreferrer" className="w-14 md:w-16 flex flex-col items-center gap-0 py-0.5 md:py-1 transition-all duration-300 rounded-lg group hover:bg-muted">
