        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <a 
              ...
              className="w-8 h-8 rounded-full bg-card/50 border border-border/30 flex items-center justify-center hover:bg-[#25D366] hover:border-transparent transition-all duration-300 hover:scale-110 group"
            >
              <svg 
          ...
          {/* Center - Brand name */}
          <span className="text-sm font-medium text-foreground/80">מזון האושר</span>
