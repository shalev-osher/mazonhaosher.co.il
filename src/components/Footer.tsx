      ...
      <div className="w-full px-3 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <button
              onClick={toggleTheme}
              className="flex flex-col items-center gap-0.5 transition-all duration-300 hover:scale-110 group"
            ...
            <button 
              ...
              className="flex flex-col items-center gap-0.5 transition-all duration-300 hover:scale-110 group"
            >
              <div className="p-1.5 md:p-2 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 shadow-md">
