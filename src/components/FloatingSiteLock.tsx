  ...
  return (
    <div className="fixed right-0 bottom-28 z-50">
      <button
        ...
        className="flex items-center py-3 px-4 bg-background/95 backdrop-blur-sm border border-r-0 border-border rounded-l-xl shadow-lg transition-all hover:scale-105 hover:shadow-xl origin-right"
      >
        <img 
