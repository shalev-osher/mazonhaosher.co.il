...
const cookieDescriptions: Record<string, { he: string; en: string }> = {
  "לוטוס": { he: "ביסקוויט לוטוס וממרח קרמל", en: "Lotus biscuit and caramel spread" },
  "קינדר": { he: "שוקולד קינדר וכדורי שוקולד צבעוניים", en: "Kinder chocolate with colorful chocolate balls" },
  "קינדר בואנו": { he: "קינדר בואנו, שוקולד חלב וציפוי שוקולד", en: "Kinder Bueno, milk chocolate and chocolate coating" },
  "רד וולווט": { he: "בצק רד וולווט, שוקולד לבן ופירורי פטל", en: "Red velvet dough, white chocolate and raspberry crumbs" },
  "פיסטוק": { he: "שוקולד לבן, פיסטוקים קלויים וגרגירי רימון", en: "White chocolate, roasted pistachios and pomegranate seeds" },
  "אוראו": { he: "פירורי אוראו, שוקולד לבן וקרם וניל", en: "Oreo crumbs, white chocolate and vanilla cream" },
  "חמאת בוטנים": { he: "חמאת בוטנים, בוטנים קלויים ושוקולד", en: "Peanut butter, roasted peanuts and chocolate" },
  "קרמל מלוח": { he: "קרמל ביתי וקריסטלי מלח ים", en: "Homemade caramel with sea salt crystals" },
};

const cookieNameTranslations: Record<string, string> = {
  "לוטוס": "Lotus",
  "קינדר": "Kinder",
  "קינדר בואנו": "Kinder Bueno",
  "רד וולווט": "Red Velvet",
  "פיסטוק": "Pistachio",
  "אוראו": "Oreo",
  "חמאת בוטנים": "Peanut Butter",
  "קרמל מלוח": "Salted Caramel",
};
...
const CookieOfTheWeek = () => {
  ...
  const descriptionData = cookieDescriptions[cookieOfWeek.cookie_name];
  const description = descriptionData ? descriptionData[language] : "";
  const displayName = language === 'en' ? (cookieNameTranslations[cookieOfWeek.cookie_name] || cookieOfWeek.cookie_name) : cookieOfWeek.cookie_name;
