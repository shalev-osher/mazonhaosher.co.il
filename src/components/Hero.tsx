        ...
        >
          ...
          <div className="flex items-end justify-center gap-6 md:gap-8">
            ...
            <a
              ...
              className="w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-110 translate-y-3"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-18 h-18 md:w-24 md:h-24 rounded-full flex items-center justify-center shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-110 -translate-y-2"
              style={{ background: 'linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888)', width: '4.5rem', height: '4.5rem' }}
